...
<head>
  ...
  <style>
    ...
    .quick-link:nth-of-type(1) { top: 10%; }  /* insta */
...
<body>
  ...
  <a href="https://www.instagram.com/_yesismail_?igsh=MXdob3NqeHJ6cTFyNw==" class="quick-link" title="Create">Create</a>
  <div id="ui"></div>
  ...
  <script>
    ...
    for (let i = 1; i <= N; i++) {
      ...
      word.textContent = 'I love you Umesh';
